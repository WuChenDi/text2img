/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 12b879375d67a9dd904092ce852fcaae)
// Runtime types generated with workerd@1.20260124.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		NEXTJS_ENV: string;
		PASSWORDS: string;
		WORKER_SELF_REFERENCE: Fetcher /* text2img */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "PASSWORDS">> {}
}
